  ...
  return (
    ...
    >
        ...
        <div className='menu-content d-flex align-items-center px-3'>
          ...
          <div className='d-flex flex-column'>
            ...
            <span className='fw-bold text-muted text-hover-primary fs-7'>
              {currentUser?.['employees.branch_detail.com_code']} - {currentUser?.['employees.branch_detail.com_name']}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className='menu-item px-5 my-1'>
        <Link to='/controls/change-password' state={currentUser?.id_number} className='menu-link px-5'>
          Change Password
        </Link>
      </div>
