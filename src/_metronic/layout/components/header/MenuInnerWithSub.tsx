...
type Props = {
  ...
  isMega?: boolean
  isMedMega?: boolean
  isModularsMega?: boolean
  isControlFileMega?: boolean
}
    ...
    <div ref={menuItemRef} className='menu-item menu-lg-down-accordion me-lg-1'>
      ...
      <div
        className={clsx(
          ...
          isMega ? 'w-100 w-lg-600px p-5 p-lg-5' : isMedMega ? 'w-100 w-lg-700px p-5 p-lg-5' : isModularsMega ? 'w-100 w-lg-1000px p-5 p-lg-5' : 'menu-rounded-0 py-lg-4 w-lg-225px'
        )}
